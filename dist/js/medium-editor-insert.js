...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mediumEditor = __webpack_require__(6);
	...
	var MediumEditorInsert = _mediumEditor2.default.Extension.extend({
	    name: 'insert',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tryCatch_1 = __webpack_require__(108);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var config_1 = __webpack_require__(19);
	var hostReportError_1 = __webpack_require__(27);
	    ...
	    var Toolbar = MediumEditor.Extension.extend({
	        ...
	        positionToolbar: function (selection) {
	            ...
	            var containerWidth = this.window.innerWidth,
	                ...
	                toolbarWidth = toolbarElement.offsetWidth,
	                halfOffsetWidth = toolbarWidth / 2,
	                buttonHeight = toolbarElement.clientHeight,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isInteropObservable_1 = __webpack_require__(104);
	var isIterable_1 = __webpack_require__(105);
	var fromArray_1 = __webpack_require__(10);
	var fromPromise_1 = __webpack_require__(72);
	var fromIterable_1 = __webpack_require__(70);
	var fromObservable_1 = __webpack_require__(71);
	var subscribeTo_1 = __webpack_require__(47);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Observable_1 = __webpack_require__(1);
	var Subscription_1 = __webpack_require__(2);
	var subscribeToArray_1 = __webpack_require__(48);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ToolbarButton = __webpack_require__(53);
	...
	var MediumEditorToolbar = _mediumEditor2.default.extensions.toolbar;
	        ...
	        value: function createToolbarButtons() {
	            ...
	            this.buttons.forEach(function (button) {
	                ...
	                if (extension && typeof extension.getButton === 'function') {
	                    ...
	                    if (_mediumEditor2.default.util.isElement(btn)) {
	                        li.appendChild(btn);
	                    } else {
	                        li.innerHTML = btn;
	                    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fromArray_1 = __webpack_require__(10);
	var empty_1 = __webpack_require__(5);
	var scalar_1 = __webpack_require__(81);
	function of() {
	    var args = [];
	    for (var _i = 0; _i < arguments.length; _i++) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var AsyncAction_1 = __webpack_require__(15);
	var AsyncScheduler_1 = __webpack_require__(16);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var throwError_1 = __webpack_require__(37);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var Observable_1 = __webpack_require__(1);
	var from_1 = __webpack_require__(9);
	var empty_1 = __webpack_require__(5);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var identity_1 = __webpack_require__(28);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QueueScheduler_1 = __webpack_require__(96);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Observable_1 = __webpack_require__(1);
	var subscribeToArray_1 = __webpack_require__(48);
	var subscribeToPromise_1 = __webpack_require__(51);
	var subscribeToIterable_1 = __webpack_require__(49);
	var subscribeToObservable_1 = __webpack_require__(50);
	var isArrayLike_1 = __webpack_require__(42);
	var isPromise_1 = __webpack_require__(45);
	var isObject_1 = __webpack_require__(44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Images = __webpack_require__(56);
	...
	var _Embeds = __webpack_require__(54);

	var _Embeds2 = _interopRequireDefault(_Embeds);

	var _Horizon = __webpack_require__(55);
	    ...
	    _createClass(Core, [{
	        ...
	        value: function positionButtons() {
	            ...
	            if (navigator.userAgent.match(/(iPhone|iPad|iPod|Android)/)) {
	                position.top -= 5;
	                var plusButton = this.buttons.getElementsByClassName('medium-editor-insert-buttons-show')[0];
	        ...
	        value: function deleteAddonElement(event, addon) {
	            var activeOverlay = this.getActiveOverlay(addon.activeClassName);

	            if (activeOverlay && (activeOverlay.classList.contains(addon.activeClassName) || activeOverlay.querySelector('.' + addon.activeClassName) // for safari
	            )) {

	                event.preventDefault();

	                var wrapper = activeOverlay.closest('.' + addon.elementClassName),
	        ...
	        key: 'selectOverlay',
	        value: function selectOverlay(event, addon) {
	            var el = event.target;
	        ...
	        key: 'unselectOverlay',
	        value: function unselectOverlay(event, addon) {
	            var el = event.target;
	        ...
	        key: 'showCaption',
	        value: function showCaption(overlay, elementClassName) {
	            var root = overlay.closest('.' + elementClassName);
	        ...
	        value: function hideCaption(el, elementClassName) {
	            var roots = _utils2.default.getElementsByClassName(this._plugin.getEditorElements(), elementClassName);
	        ...
	        value: function getActiveOverlay(activeClassName) {
	        ...
	        key: 'activateOverlay',
	        value: function activateOverlay(overlay, addon) {
	            if (overlay) {
	        ...
	        value: function focusOnPreviousElement(event, addon) {
	            ...
	            var range = _mediumEditor2.default.selection.getSelectionRange(document),
	                ...
	                isBackspace = _mediumEditor2.default.util.isKey(event, _mediumEditor2.default.util.keyCode.BACKSPACE),
	                isDelete = _mediumEditor2.default.util.isKey(event, _mediumEditor2.default.util.keyCode.DELETE);
	            var sibling = void 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ToolbarButton = _mediumEditor2.default.extensions.button.extend({
	    init: function init() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rxjs = __webpack_require__(59);
	    ...
	    _createClass(Video, [{
	        ...
	        value: function uploadFile() {
	            ...
	            if (file.size > this.options.maxBytes) {
	                ...
	                var errorObj = { type: 'error', name: 'BigFileSizeError', data: { maxBytes: this.options.maxBytes, size: file.size } };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var groupBy_1 = __webpack_require__(86);
	...
	var ReplaySubject_1 = __webpack_require__(61);
	exports.ReplaySubject = ReplaySubject_1.ReplaySubject;
	var AsyncSubject_1 = __webpack_require__(23);
	exports.AsyncSubject = AsyncSubject_1.AsyncSubject;
	var asap_1 = __webpack_require__(99);
	exports.asapScheduler = asap_1.asap;
	var async_1 = __webpack_require__(25);
	exports.asyncScheduler = async_1.async;
	var queue_1 = __webpack_require__(39);
	exports.queueScheduler = queue_1.queue;
	var animationFrame_1 = __webpack_require__(98);
	exports.animationFrameScheduler = animationFrame_1.animationFrame;
	var VirtualTimeScheduler_1 = __webpack_require__(97);
	...
	var Notification_1 = __webpack_require__(31);
	...
	var isObservable_1 = __webpack_require__(106);
	exports.isObservable = isObservable_1.isObservable;
	var ArgumentOutOfRangeError_1 = __webpack_require__(100);
	...
	var TimeoutError_1 = __webpack_require__(103);
	exports.TimeoutError = TimeoutError_1.TimeoutError;
	var bindCallback_1 = __webpack_require__(63);
	exports.bindCallback = bindCallback_1.bindCallback;
	var bindNodeCallback_1 = __webpack_require__(64);
	exports.bindNodeCallback = bindNodeCallback_1.bindNodeCallback;
	var combineLatest_1 = __webpack_require__(65);
	exports.combineLatest = combineLatest_1.combineLatest;
	var concat_1 = __webpack_require__(66);
	exports.concat = concat_1.concat;
	var defer_1 = __webpack_require__(35);
	...
	var fromEvent_1 = __webpack_require__(68);
	exports.fromEvent = fromEvent_1.fromEvent;
	var fromEventPattern_1 = __webpack_require__(69);
	exports.fromEventPattern = fromEventPattern_1.fromEventPattern;
	var generate_1 = __webpack_require__(73);
	exports.generate = generate_1.generate;
	var iif_1 = __webpack_require__(74);
	exports.iif = iif_1.iif;
	var interval_1 = __webpack_require__(75);
	exports.interval = interval_1.interval;
	var merge_1 = __webpack_require__(76);
	exports.merge = merge_1.merge;
	var never_1 = __webpack_require__(36);
	exports.never = never_1.never;
	var of_1 = __webpack_require__(24);
	exports.of = of_1.of;
	var onErrorResumeNext_1 = __webpack_require__(77);
	exports.onErrorResumeNext = onErrorResumeNext_1.onErrorResumeNext;
	var pairs_1 = __webpack_require__(78);
	exports.pairs = pairs_1.pairs;
	var race_1 = __webpack_require__(79);
	exports.race = race_1.race;
	var range_1 = __webpack_require__(80);
	exports.range = range_1.range;
	var throwError_1 = __webpack_require__(37);
	exports.throwError = throwError_1.throwError;
	var timer_1 = __webpack_require__(82);
	exports.timer = timer_1.timer;
	var using_1 = __webpack_require__(83);
	exports.using = using_1.using;
	var zip_1 = __webpack_require__(84);
	exports.zip = zip_1.zip;
	var empty_2 = __webpack_require__(5);
	exports.EMPTY = empty_2.EMPTY;
	var never_2 = __webpack_require__(36);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var queue_1 = __webpack_require__(39);
	var Subscription_1 = __webpack_require__(2);
	var observeOn_1 = __webpack_require__(88);
	var ObjectUnsubscribedError_1 = __webpack_require__(20);
	var SubjectSubscription_1 = __webpack_require__(34);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Subscriber_1 = __webpack_require__(3);
	var Subscription_1 = __webpack_require__(2);
	var refCount_1 = __webpack_require__(89);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var of_1 = __webpack_require__(24);
	var from_1 = __webpack_require__(9);
	var concatAll_1 = __webpack_require__(85);
	function concat() {
	    var observables = [];
	    for (var _i = 0; _i < arguments.length; _i++) {
	        observables[_i] = arguments[_i];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Observable_1 = __webpack_require__(1);
	var async_1 = __webpack_require__(25);
	var isNumeric_1 = __webpack_require__(43);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var Immediate_1 = __webpack_require__(102);
	var AsyncAction_1 = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var AnimationFrameAction_1 = __webpack_require__(91);
	var AnimationFrameScheduler_1 = __webpack_require__(92);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	Object.defineProperty(exports, "__esModule", { value: true });
	var AsapAction_1 = __webpack_require__(93);
	var AsapScheduler_1 = __webpack_require__(94);
